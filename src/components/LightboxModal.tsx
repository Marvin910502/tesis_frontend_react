 ...
 * @description A modal that displays images in a lightbox format
 * @param {ILightBoxProps} props - Props to pass to the Lightbox component
 * @param {string[]} props.images - An array of image URLs to display
 * @param {number} props.photoIndex - The index of the image to display
 * @param {function} props.setPhotoIndex - A function to set the index of the image to display
